...
(() => {
    ...
    function g(t, e, o, i) {
        return t ? (t.addEventListener(e, o, i), () => t.removeEventListener(e, o, i)) : b
    }
    ...
    var $ = t => !!(t.offsetWidth || t.offsetHeight || t.getClientRects().length);
    ...
    var N = t => e => `${t}${e?`-${e}`:""}`,
        B = t => {
            let e = (r, n, s) => {
                ...
                S(m) ? l = m : l = m(s && "instanceIndex" in s ? s.instanceIndex : void 0);
    ...
    var et = ({
        ...
        Nt = () => {
            ...
            let e = Bt(t);
            F(e, t), Kt(e), window.fsAttributes = e, window.FsAttributes = window.fsAttributes, Z()
        },
        Bt = t => {
            let e = {
                cms: {},
                ...
                import (o, i) {
                    ...
                    return r || new Promise(n => {
                        ...
                        s.src = U(o, i), s.async = !0, s.onload = () => {
                            let [a] = F(e, [o]);
                            n(a)
                ...
                destroy() {
                    var o, i;
                    for (let r of t)(i = (o = window.fsAttributes[r]) == null ? void 0 : o.destroy) == null || i.call(o)
                }
            };
            return e
        },
        Ct = () => {
            let t = V("src", "finsweet", {
                    operator: "contains"
                }),
                e = V("dev");
            return [...document.querySelectorAll(`script${t}, script${e}`)].reduce((r, n) => {
                var a;
                let s = n.getAttribute(I.dev.key) || ((a = n.src.match(/[\w-. ]+(?=(\.js)$)/)) == null ? void 0 : a[0]);
                return s && !r.includes(s) && r.push(s), r
            }, [])
        },
        F = (t, e) => e.map(i => {
            let r = t[i];
            return r || (t[i] = {}, r = t[i], r.loading = new Promise(n => {
                r.resolve = s => {
    ...
    var rt = () => {
        var t, e;
        return (e = (t = window.fsAttributes).import) == null ? void 0 : e.call(t, W, "1")
    };
    var nt = (t = 21) => crypto.getRandomValues(new Uint8Array(t)).reduce((e, o) => (o &= 63, o < 36 ? e += o.toString(36) : o < 62 ? e += (o - 26).toString(36).toUpperCase() : o > 62 ? e += "-" : e += "_", e), "");
    var H = t => {
    ...
    var mt = (t, e, o) => {
        ...
        for (let n of [...e, ...o]) {
            ...
            n.setAttribute(it, "0"), n.setAttribute(j, "button"), n.setAttribute(lt, i), n.setAttribute(at, "dialog"), n.setAttribute(ct, String(r)), n.hasAttribute(q) || n.setAttribute(q, `${s}-modal-trigger`)
        }
    };
    var f = `fs-${T}`,
        ht = "modal",
        ...
        [At, _, y] = B(G),
        Tt = `${f}-anchor`,
        dt = ["block", "inline", "inline-block", "flex", "inline-flex", "grid", "inline-grid", "none", "contents"],
        Et = "flex";
    var C = (t, {
        animations: e,
        easings: o
    ...
    var ft = (t, e, o, i, r) => {
            ...
            let {
                ...
                easing: c,
                display: p
            } = i, l = $t(t, r), m = new Comment(Tt);
            n.insertBefore(m, t);
            let u = !1,
                R, It = e.map(A => g(A, "click", async K => {
                    K.preventDefault(), !(u || R) && (u = !0, await Promise.all([s.animateIn(t, {
                        duration: a,
                        easing: c,
                        display: p || Et,
                ...
                _t = o.map(A => g(A, "click", async K => {
                    K.preventDefault(), !(u || R === !1) && (u = !0, await Promise.all([s.animateOut(t, {
                        duration: a,
                        easing: c,
                        target: n,
                        insertAfter: m
        ...
        $t = (t, e) => {
            let i = ["animation", "duration", "easing", "display"].map(s => At(s)).join(",");
